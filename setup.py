...
def get_version_number():
  path_to_written_version = 'SORE/__init__.py'
...
def find_scripts():
  ...
  for scripts_folder in scripts_folders:
    for root, dirs, files in os.walk('SORE/'+scripts_folder, topdown=False):
      for file in files:
...
setup(name='SORE',
      ...
      author='Dr. Geoffrey Weal, Dr. Chayanit Wechwithayakhlung, Assoc. Prof. Daniel Packwood, Dr. Paul Hume, Prof. Justin Hodgkiss',
      author_email='paul.hume@vuw.ac.nz',
      download_url = 'https://github.com/geoffreyweal/SORE/archive/v'+str(get_version_number())+'.tar.gz',
